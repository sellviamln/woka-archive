...
>>>>>>> 7de0e097a0507b6623dd1a39d246ed7f094ff54a
                    ...
                    <div class="shadow-sm rounded-4 p-4"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" name="email" class="form-control bg-transparent border shadow-sm rounded-3 py-2" value="{{ $staff->user->email ?? '-' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="string" name="no_hp" class="form-control bg-transparent border shadow-sm rounded-3 py-2"value="{{ $staff->no_hp ?? '-' }}" >
>>>>>>> 7de0e097a0507b6623dd1a39d246ed7f094ff54a
                            ...
                            <div class="small text-muted text-start ps-3">
                                <div class="mb-1"><i class="bi bi-tag me-1"></i> <strong>Departemen</strong> {{ $staff->departemen->nama_departemen ?? '-' }}</div>
                                <div class="mb-1"><i class="bi bi-building me-1"></i> <strong>No Hp</strong> {{ $staff->no_hp ?? '-' }}</div>
                                <div class="mb-1"><i class="bi bi-building me-1"></i> <strong>Status</strong> {{ ucfirst($staff->user->status ?? '-') }}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                        <div class="shadow-sm rounded-4 p-4"
                            ...
                            <div class="row g-3">
                                ...
                                {{-- Input file hidden --}}
                                <input type="file" id="uploadFoto" name="foto" class="d-none" accept="image/*" onchange="this.form.submit()">
